...
def verify_with_outage_prob(size=10000, model=None, verbose=0, gamma_th=None):
    config = util.ExpConfig()
    ...
    # outage probability
    out_prob_bf = util.get_outage_prob(data, bf_result, gamma_th=gamma_th)
    out_prob_predict = util.get_outage_prob(data, result, gamma_th=gamma_th)
    op_random = util.get_outage_prob(data, random_result, gamma_th=gamma_th)
    op_bulk = util.get_outage_prob(data, bulk_result, gamma_th=gamma_th)
    op_persub = util.get_outage_prob(data, persub_result, gamma_th=gamma_th)
...
if __name__ == '__main__':
    mse, acc = verify_with_outage_prob(size=100)
    print(mse, acc)
